...
echo https://www.manx98.shop/colo.txt 另存为 colo.txt
echo https://www.manx98.shop/url.txt 另存为 url.txt
echo https://www.manx98.shop/ips-v4.txt 另存为 ips-v4.txt
echo https://www.manx98.shop/ips-v6.txt 另存为 ips-v6.txt
goto datacheck

:datacheck
if not exist "colo.txt" echo 从服务器下载数据中心信息 colo.txt&curl --retry 2 -s https://www.manx98.shop/colo.txt -o colo.txt&goto datacheck
if not exist "url.txt" echo 从服务器下载测速文件地址 url.txt&curl --retry 2 -s https://www.manx98.shop/url.txt -o url.txt&goto datacheck
if not exist "ips-v4.txt" echo 从服务器下载IPV4数据 ips-v4.txt&curl --retry 2 -s https://www.manx98.shop/ips-v4.txt -o ips-v4.txt&goto datacheck
if not exist "ips-v6.txt" echo 从服务器下载IPV6数据 ips-v6.txt&curl --retry 2 -s https://www.manx98.shop/ips-v6.txt -o ips-v6.txt&goto datacheck
set /a n=0
