...
echo https://www.manx98.shop/colo.txt ����Ϊ colo.txt
echo https://www.manx98.shop/url.txt ����Ϊ url.txt
echo https://www.manx98.shop/ips-v4.txt ����Ϊ ips-v4.txt
echo https://www.manx98.shop/ips-v6.txt ����Ϊ ips-v6.txt
goto datacheck

:datacheck
if not exist "colo.txt" echo �ӷ�������������������Ϣ colo.txt&curl --retry 2 -s https://www.manx98.shop/colo.txt -o colo.txt&goto datacheck
if not exist "url.txt" echo �ӷ��������ز����ļ���ַ url.txt&curl --retry 2 -s https://www.manx98.shop/url.txt -o url.txt&goto datacheck
if not exist "ips-v4.txt" echo �ӷ���������IPV4���� ips-v4.txt&curl --retry 2 -s https://www.manx98.shop/ips-v4.txt -o ips-v4.txt&goto datacheck
if not exist "ips-v6.txt" echo �ӷ���������IPV6���� ips-v6.txt&curl --retry 2 -s https://www.manx98.shop/ips-v6.txt -o ips-v6.txt&goto datacheck
set /a n=0
